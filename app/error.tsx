...
export default function Error({
    ...
    return (
        <div className="flex flex-col lg:flex-row justify-center gap-10 items-center p-10 mt-20">
            <Image src={"/error-image.svg"} alt={"Not found image."} width={500} height={500} />
            <div className="flex flex-col gap-5 items-center">
                <div className="order-last lg:order-first text-3xl text-red-700 lg:w-[400px] text-wrap text-center">Xin lỗi, Đã xảy ra lỗi! </div>
